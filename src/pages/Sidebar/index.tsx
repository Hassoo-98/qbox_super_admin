...
const Sidebar: React.FC = () => {
    ...
    const handleMenuClick: MenuProps['onClick'] = (e) => {
        switch (e.key) {
            ...
            case '8': navigate("/staffs", { replace: true }); break;
            case '9': navigate("/rolepermissions", { replace: true }); break;
            case '10': navigate("/qrlogs", { replace: true }); break;
            case '11': navigate("/settingpages", { replace: true }); break;
            case '12': navigate("/activitylogs", { replace: true }); break;
            default: break;
        }
    };
