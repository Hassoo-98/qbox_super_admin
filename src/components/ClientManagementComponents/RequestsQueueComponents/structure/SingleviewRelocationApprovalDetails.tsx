...
import { relocationapprovalrequestData } from "../../../../data";
import { useTranslation } from "react-i18next";
import i18n from "../../../../sources/i18n";

const { Text, Title } = Typography;
const SingleviewRelocationApprovalDetails: React.FC = () => {
  ...
  const { id } = useParams();
  const details = relocationapprovalrequestData?.find(
  ...
  return (
    <>
      ...
      <ActiveModal
        ...
        desc={t("Are you sure you want to approve this homeowner request?")}
      />
      <InactiveModal
...
export { SingleviewRelocationApprovalDetails };
