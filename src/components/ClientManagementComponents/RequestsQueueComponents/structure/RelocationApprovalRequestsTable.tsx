...
import { relocationapprovalrequestData, type RelocationApprovalItems } from "../../../../data";
        ...
        },
        {
            ...
            render: (_, row: RelocationApprovalItems) => {
                const items: MenuProps["items"] = [
                    {
                        label: (
                            <NavLink to="/" onClick={(e) => { e.preventDefault(); navigate('/requestsqueue/relocationapprovaldetails/' + row?.key) }}>
                                {t("View")}
                            </NavLink>
                        ),
                        key: "1",
