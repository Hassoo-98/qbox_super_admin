...
import { revenuesubColumn, revenuesubData } from "../../../../data";
import { CustomPagination, SubscriptionExportModal } from "../../../PageComponents";


const SubscriptionBaseRevenueTable = () => {
        ...
        <>
            <Flex vertical gap={15}>
                ...
                <Flex vertical gap={20}>
                    <Table<RevenueType>
                        size='large'
                        columns={revenuesubColumn(t)}
                        dataSource={revenuesubData}
...
export { SubscriptionBaseRevenueTable } 
